...
## Screenshot
![Screenshot Folder Project](images/folder-project.png)
...
## Screenshot
![Screenshot Install CI4](images/install-ci4.png)
...
## Screenshot
![Screenshot PHP.ini](images/phpini.png)
...
## Screenshot
![Screenshot Spark Serve](images/spark-serve.png)
...
## Screenshot
![Screenshot Routes](images/routes.png)
...
## Screenshot
![Screenshot Controller](images/controller.png)
...
## Screenshot
![Screenshot View](images/view.png)
...
## Screenshot
![Screenshot Template](images/template.png)
...
## Halaman About
![Screenshot About](images/about.png)

## Halaman Contact
![Screenshot Contact](images/contact.png)

## Halaman FAQ
![Screenshot FAQ](images/faqs.png)
...
## Screenshot
![Screenshot Routes CMD](images/spark-routes.png)
...
## Screenshot
![Screenshot Database](images/database.png)
...
## Screenshot
![Screenshot Table Artikel](images/table-artikel.png)
...
## Screenshot
![Screenshot Insert Artikel](images/insert-artikel.png)
...
## Screenshot
![Screenshot Database Config](images/db-config.png)
...
## Screenshot
![Screenshot Model](images/model.png)
...
## Screenshot
![Screenshot Artikel Controller](images/artikel-controller.png)
...
## Screenshot
![Screenshot View Artikel](images/view-artikel.png)
...
## Screenshot
![Screenshot Routes Artikel](images/spark-routes-p3.png)
...
## Screenshot
![Screenshot Halaman Artikel](images/halaman-artikel.png)
...
## Screenshot
![Screenshot Spark Routes](images/spark-routes.png)
...
## Screenshot
![Screenshot Layout Main](images/layout-main.png)
...
## Screenshot
![Screenshot About Layout](images/about-layout.png)
...
## Screenshot
![Screenshot Artikel Terkini Cell](images/artikel-terkini-cell.png)
...
## Screenshot
![Screenshot Artikel Terkini View](images/artikel-terkini-view.png)
...
## Screenshot
![Screenshot Halaman Layout](images/halaman-layout.png)
...
## Screenshot
![Screenshot Sidebar Widget](images/sidebar-widget.png)
...
## Screenshot
![Screenshot Spark Serve P3](images/spark-server-p3.png)
...
## Screenshot
![Screenshot Spark Routes P3](images/spark-routes-p3.png)
...
## Screenshot
![Screenshot Table User](images/table-user.png)
...
## Screenshot
![Screenshot User Model](images/user-model.png)
...
## Screenshot
![Screenshot User Controller](images/user-controller.png)
...
## Screenshot
![Screenshot Login View](images/login-view.png)
...
## Screenshot
![Screenshot User Seeder](images/user-seeder.png)
...
## Screenshot
![Screenshot Spark Seeder](images/spark-seeder.png)
...
## Screenshot
![Screenshot Auth Filter](images/auth-filter.png)
...
## Screenshot
![Screenshot Filters Config](images/filters-config.png)
...
## Screenshot
![Screenshot Routes Login](images/routes-login.png)
...
## Screenshot
![Screenshot Halaman Login](images/halaman-login.png)
...
## Screenshot
![Screenshot Login Berhasil](images/login-berhasil.png)
...
## Screenshot
![Screenshot Redirect Login](images/redirect-login.png)
...
## Screenshot
![Screenshot Pagination Controller](images/pagination-controller.png)
...
## Screenshot
![Screenshot Admin Index View](images/admin-index-view.png)
...
## Screenshot
![Screenshot Pagination Links](images/pagination-links.png)
...
## Screenshot
![Screenshot Data Artikel Banyak](images/data-artikel-banyak.png)
...
## Screenshot
![Screenshot Halaman Pagination](images/halaman-pagination.png)
...
## Screenshot
![Screenshot Halaman Search](images/halaman-search.png)
...
## Screenshot
![Screenshot Spark Serve P5](images/spark-serve-p5.png)
...
![Filter kategori halaman admin](images/praktikum6-admin-filter-kategori.png)
...
![Daftar artikel dengan kategori](images/praktikum6-artikel-kategori.png)
...
![Form upload gambar artikel](images/praktikum7-form-upload.png)
...
![Hasil upload gambar pada detail artikel](images/praktikum7-hasil-upload.png)
...
![Tabel artikel dari AJAX](images/praktikum8-tabel-ajax.png)
...
![Form tambah artikel AJAX](images/praktikum8-form-ajax.png)
...
- `images/spark-routes-p3.png` untuk screenshot route artikel;
- `images/spark-server-p3.png` untuk screenshot server Praktikum 3.
...
# 5. Menambahkan Loading Indicator dan Penanganan Error

Ketika request berlangsung, halaman menampilkan spinner dan teks `Memuat data artikel...`.
Tabel diberi atribut `aria-busy` agar status pemuatan juga terbaca oleh teknologi bantu.
Jika request gagal, tabel menampilkan pesan error dan pengguna dapat mencoba kembali.

Desain filter, loading indicator, tabel, dan pagination dibuat responsif melalui
`public/style.css`.
...
| Pengujian | Hasil |
|---|---|
| Response AJAX berformat JSON | Berhasil |
| Halaman pertama berisi maksimal 10 artikel | Berhasil |
| Tombol halaman 2 memuat tiga artikel tanpa reload | Berhasil |
| Live search `CodeIgniter` menemukan dua artikel | Berhasil |
| Sorting judul `ASC` menghasilkan urutan yang benar | Berhasil |
| Filter kategori dapat dikombinasikan dengan pencarian | Berhasil |
| Loading indicator tampil selama request | Berhasil |
| Parameter sorting tidak valid kembali ke nilai aman | Berhasil |

Pengujian browser menghasilkan 13 artikel, dua halaman, 10 artikel pada halaman pertama,
dan tiga artikel pada halaman kedua. Pencarian `CodeIgniter` menghasilkan dua artikel
dalam urutan judul ascending.

---

# 7. Perbaikan Folder Screenshot README

Seluruh file dokumentasi gambar dipindahkan dari folder `screenshots` ke folder `images`.
Semua link gambar pada README juga diperbarui menjadi `images/nama-file.png`, termasuk
screenshot Praktikum 9 di atas. Dengan demikian, path file pada repository sama dengan
path Markdown dan gambar dapat tampil pada GitHub.

---

# Kesimpulan Praktikum 9

Praktikum 9 berhasil menambahkan AJAX pagination, live search, filter kategori, sorting,
loading indicator, metadata jumlah data, serta penanganan error pada halaman admin artikel.
Semua interaksi utama berjalan tanpa reload halaman penuh dan tetap memiliki fallback HTML.
